...
export function getAppElements() {
  return {
    ...
    themeToggleBtn: queryRequired('#themeToggleBtn'),
    themeToggleIcon: queryRequired('#themeToggleIcon'),
    themeToggleLabel: queryRequired('#themeToggleLabel'),
    themeStatus: queryRequired('#themeStatus'),
